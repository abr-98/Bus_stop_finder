...
def run_program(threshold):
    ...
    first_level_cluster.main(directory,DISTANCE_THRESHOLD,TIME_START,TIME_END,TRAIL_ID_RANGE) #first argument is the input directory and the second argument is the output file
